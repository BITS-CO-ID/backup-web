                ...
                <?php if($row->list_no=="2"){            
                    ...
                    <div class="pricing_table">
                        ...
                        <ul>
                            ...
                            else if($tme_duration['time_durt']=='5') {echo " Tahun";}else if($tme_duration['time_durt']=='6') {echo "ot";} else{ echo "pm";}?>
                            </span></span></li>
                            <?php } else {?>
                ...
                <?php if($row->list_no=="2"){            
                    ...
                    <div class="pricing_table">
                        ...
                        <ul>
                            ...
                            else if($row->time_duration=='3'){ echo " Tahun";}else if($row->time_duration=='4'){ echo "hr";}
