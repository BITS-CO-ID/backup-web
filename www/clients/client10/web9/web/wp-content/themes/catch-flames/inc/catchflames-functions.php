...
function catchflames_footer_content() { 
	...
	echo '<div class="copyright">Copyright © 2015 <a href="http://baittauhied.com/" title="Yayasan Bait et Tauhied"><span>Yayasan Bait et Tauhied</span></a> All Rights Reserved.</div><div class="powered"><span class="theme-name">Web Developed by </span><span class="theme-author"><a href="https://bits.co.id/" target="_blank" title="Banten IT Solutions">BITS.CO.ID</a></span></div></div>';
}
