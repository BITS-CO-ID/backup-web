...
<!Doctype html>
        <html>
            <head>
                ...
                <title>Member Area - Forum Komunikasi Kota Serang</title>
...
<section class="tengah">
        <h1 style="font-size:2em;text-align:center;border-bottom:1px solid #ccc;margin:0 0 10px 0;padding: 0 0 10px 0;">Member Area</h1>
      <?php the_content(); ?>
</section>
  <?php endwhile; ?>
        <div class="spasi"></div>
